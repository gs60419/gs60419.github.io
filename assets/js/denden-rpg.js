...
const questions = {
  map: [
    ...
    ["有人丟出一句沒頭沒尾、讓你停一下的話。在還不知道真相前，你通常先注意：", ["這句話跟我有什麼關係？", "對方現在的語氣或情緒。", "前後發生了什麼事。", "我現在資訊不夠，先不要急著判斷。"]],
  ...
  mount: [
    ["走進一個陌生地方，你通常先注意：", ["氣氛是否舒服、哪些細節需要留意。", "大家彼此怎麼互動、誰跟誰比較近。", "規則、動線、位置、接下來要做什麼。"]],
    ["跟人聊天時，你比較常：", ["注意表情、語氣、停頓這些小變化。", "很快感覺到對方現在心情往哪裡走。", "先在腦中整理好邏輯，再回答。"]],
    ["到新環境時，你最常：", ["先安靜觀察一圈。", "先感覺這裡的人好不好相處。", "先弄清楚流程和規則。"]],
    ["你最容易被哪種狀況卡住？", ["突然很吵，或氣氛變得緊繃。", "大家不說清楚感受，場面很尷尬。", "流程亂掉、資訊不清楚。"]],
    ["要做決定時，你通常比較相信：", ["心裡那個「有地方不太對」的直覺。", "大家的感受和關係氣氛。", "事情本身合不合理、路徑清不清楚。"]],
